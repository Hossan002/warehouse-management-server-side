...
const uri = `mongodb+srv://${process.env.USER_NAME}:${process.env.USER_PASS}@cluster0.dcshi.mongodb.net/?retryWrites=true&w=majorit`;
...
const run = async () => {
  try {
    ...
    app.get("/", async (req, res) => {
      res.send("Fruists Warehouse server successfully Run");
    });
  } finally {
  }
};
...
app.listen(port, () => console.log("Fruists Warehouse Stock on port:", port));
